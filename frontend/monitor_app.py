...
/* Giriş sayfasında tüm arkaplanı beyaz yap */
.login-page [data-testid="stAppViewContainer"] { background-color: #f4f7fc !important; }
</style>
...
<div class="login-box">
  <div style="text-align:center;margin-bottom:28px;">
    {_logo_html(110)}
    <div style="font-size:1.6rem;font-weight:800;color:#1a2540;margin-top:16px;letter-spacing:-0.5px;">
      {_u["app_title"]}
    </div>
    <div style="font-size:0.82rem;color:#6b7fa8;margin-top:6px;">{_u["app_sub"]}</div>
  </div>
</div>
""", unsafe_allow_html=True)
        with st.form("login_form"):
            ...
            if st.form_submit_button(_u["login_btn"], type="primary"):
...
<div class="login-box">
  <div style="text-align:center;margin-bottom:10px;">
    {_logo_html(90)}
    <div style="font-size:1.1rem;font-weight:700;color:#1a2540;margin-top:14px;">{_u["welcome"]}, {_display}!</div>
    <div style="font-size:0.82rem;color:#6b7fa8;margin-top:4px;">{_u["select_machine"]}</div>
  </div>
</div>
""", unsafe_allow_html=True)
...
with _tab_status:
    ...
    def _status_fragment():
        ...
        # ── Durum kartları ─────────────────────────────────────────────────
        st.markdown(f'<div class="section-title">{_u["sec_status"]}</div>', unsafe_allow_html=True)
        _s = _d.get("status") or {}
        ...
        # ── Alarmlar ───────────────────────────────────────────────────────
        st.divider()
        st.markdown(f'<div class="section-title">{_u["sec_alarms"]}</div>', unsafe_allow_html=True)
        ...
        if _cnt == 0:
            ...
            st.markdown(f'<div class="alarm-active">⚠️ {_cnt} {_u["alarm_active"]}</div>', unsafe_allow_html=True)
        ...
        # ── Basınçlar ──────────────────────────────────────────────────────
        st.divider()
        st.markdown(f'<div class="section-title">{_u["sec_pressures"]}</div>', unsafe_allow_html=True)
        ...
        # ── Sıcaklıklar ────────────────────────────────────────────────────
        st.divider()
        st.markdown(f'<div class="section-title">{_u["sec_temps"]}</div>', unsafe_allow_html=True)
        ...
        # ── Pozisyonlar ────────────────────────────────────────────────────
        st.divider()
        st.markdown(f'<div class="section-title">{_u["sec_positions"]}</div>', unsafe_allow_html=True)
...
with _tab_alarm:
    ...
    def _alarm_fragment():
        ...
        # ── Anomali durumu ─────────────────────────────────────────────────
        st.markdown(f'<div class="section-title">{_u["sec_anomaly"]}</div>', unsafe_allow_html=True)
        ...
        if not _an:
            ...
            st.markdown(f'<span style="color:#ff9800;font-weight:600;">{_u["anomaly_found"]}</span>', unsafe_allow_html=True)
            for _line in _an.get("detail_lines", []):
                st.markdown(f"- {_line}")
        else:
            st.markdown(f'<span style="color:#4caf7a;font-weight:600;">{_u["anomaly_ok"]}</span>', unsafe_allow_html=True)
            st.caption(f'{_an.get("total_cycles", 0)} {_u["cycles_analyzed"]}')

        # ── Günlük istatistikler ───────────────────────────────────────────
        st.divider()
        st.markdown(f'<div class="section-title">{_u["sec_daily"]}</div>', unsafe_allow_html=True)
        ...
        if _dd:
            ...
            if _top:
                st.markdown(f'<div class="section-title" style="margin-top:12px;">{_u["sec_top_alarms"]}</div>', unsafe_allow_html=True)
                for _item in _top[:5]:
        ...
        # ── 7 günlük trend ─────────────────────────────────────────────────
        st.divider()
        st.markdown(f'<div class="section-title">{_u["sec_trend"]}</div>', unsafe_allow_html=True)
...
with _tab_energy:
    ...
    def _energy_fragment():
        ...
        st.markdown(f'<div class="section-title">{_u["sec_energy"]}</div>', unsafe_allow_html=True)
        ...
        # ── Vardiya özeti ──────────────────────────────────────────────────
        st.divider()
        st.markdown(f'<div class="section-title">{_u["sec_shift"]}</div>', unsafe_allow_html=True)
        ...
        # ── 24 saatlik trend ───────────────────────────────────────────────
        st.divider()
        st.markdown(f'<div class="section-title">{_u["sec_ene_trend"]}</div>', unsafe_allow_html=True)
        ...
        # ── Cycle bazlı tüketim ────────────────────────────────────────────
        st.divider()
        st.markdown(f'<div class="section-title">{_u["sec_cycle_ene"]}</div>', unsafe_allow_html=True)
